		...
		if(!closedState) {
			...
			switch (sickBeats #if tgt * 0.5 #end)
			{
				...
				case 2:
					...
					addMoreText('Fuckin Engine By', 0);
					addMoreText('InvisibleMan', 8);
					addMoreText('Troll Engine By', 16);
					addMoreText('Riconuts/Nebulazorua', 16);
					addMoreText('AND MORE');
				case 4: 
					deleteCoolText();
				addMoreText('We love modcharts!', 75);
